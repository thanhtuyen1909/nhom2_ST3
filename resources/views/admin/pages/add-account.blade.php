    ...
    <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">Thêm tài khoản</h2>
                    </div>
                </div>
                <div class="row tm-edit-product-row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                        ...
                        <div class="custom-file mt-3 mb-3">
                            ...
                            <input type="button" class="btn btn-primary btn-block mx-auto" value="THÊM ẢNH ĐẠI DIỆN" onclick="document.getElementById('fileInput').click();" />
                        </div>
                    </div>
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block text-uppercase">THÊM TÀI KHOẢN</button>
                    </div>
                </div>
            </div>
        </div>
